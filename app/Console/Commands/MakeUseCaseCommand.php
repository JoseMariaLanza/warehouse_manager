...
class MakeUseCaseCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:usecase {app} {module} {layer} {name}';
     ...
     * @var string
     */
    protected $description = 'Make an use case class';
    ...
    public function getStubVariables()
    {
        return [
            ...
            'MODULE_NAME'        => ucwords($this->argument('module')),
            'LAYER_NAME'        => ucwords($this->argument('layer')),
            'ENTITY'        => $this->getSingularClassName($this->argument('name')),
    ...
    public function getSourceFilePath()
    {
        ...
        return base_path($appName . '\\' . $moduleName . '\\' . $layerName)
            . '\\' . $entity . 'UseCases' . '\\' . $entity . 'StoreUseCase.php';
    }
